...
export default function App() {
  ...
  // Optional UX: if client changes, keep tab but components will handle "select a client" gating.
  // If you prefer forcing user back to Record on client change, uncomment:
  // const handleClientChange = (id) => { setSelectedClientId(id); setActiveTab("record"); };
